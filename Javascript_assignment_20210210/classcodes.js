...
// x = new Person("Jojo", 222);
// y = new Dog("dog", 1);
// z = new Animal("none", 111);
// q = new Dog("dog1", 3);
// y.__proto__.speak = function () { console.log("wang");}
...
//找出数组中的偶数， 可用reduce和filter
// const arr = [1,2,3,4,5,6,7,8];
// const arrr = arr.reduce(function(acc, ele){if(ele%2 === 0){acc.push(ele);} return acc;}, []);
// console.log(arrr);
...
// Object.prototype.myForEach = function (callBackFn) {
...
// const wallet = function (initMoney) {
//     console.log(`Initial money ${initMoney}`);
//     let money = initMoney;
...
// const wallet1 = wallet(1000);
// const wallet2 = wallet(2000);
...
// console.log(bar(5)); // 9
// console.log(bar(6)); // 10
// console.log(bar(7)); // 11



///////My Implementation
// limitedFn = function (limit, callBack) {
//     let count = 0;
...
//     }
// }
// const foo = limitedFn(3, (a, b) => console.log(a + b));
...
// foo = function (){
//     bar = i => {setTimeout(()=> console.log(i), i*1000)};
//     for (var i = 0; i < 5; i++){
//         bar(i);
//     }
// }
